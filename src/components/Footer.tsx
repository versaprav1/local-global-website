        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-muted hover:text-background transition-colors">{t('common.nav.about')}</a></li>
              <li><a href="#centers" className="text-muted hover:text-background transition-colors">{t('common.nav.services')}</a></li>
              <li><a href="#specialists" className="text-muted hover:text-background transition-colors">{t('common.nav.blog')}</a></li>
