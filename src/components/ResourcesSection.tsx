      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg">
            Access guides, tools, and support to help you expand from local to global markets.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto bg-card shadow-lg rounded-xl p-8 text-center border">
          ...
          <p className="text-muted-foreground mb-6">
            Our team of experts is ready to provide personalized guidance for your specific needs.
          </p>
