...
import { useGuides, usePartners, useVideos } from "@/hooks/useResources";
    ...
    <section id="resources" className="py-16 md:py-24 bg-gradient-to-b from-background to-muted/30">
      <div className="container mx-auto px-4">
        ...
        <Tabs defaultValue="resources" className="w-full">
          ...
          {/* Guides Tab - Now from Supabase */}
          <TabsContent value="guides">
            {guidesLoading ? <SkeletonGrid /> : guides.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-12">
                {guides.map((guide) => (
                  <Card key={guide.id} className="border card-hover h-full">
                    <CardContent className="p-6 flex flex-col h-full">
          ...
          {/* Partners Tab - Now from Supabase */}
          <TabsContent value="partners">
            ...
            {partnersLoading ? <SkeletonGrid /> : partners.length === 0 ? (
              <div className="text-center py-12 text-muted-foreground">
                <Users className="h-12 w-12 mx-auto mb-4 opacity-50" />
                <p>No partners listed yet. <Link to="/partners" className="text-primary underline">Apply to be a partner</Link>.</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-12">
          ...
          {/* Videos Tab - Now from Supabase */}
          <TabsContent value="videos">
            {videosLoading ? <SkeletonGrid /> : videos.length === 0 ? (
              <div className="text-center py-12 text-muted-foreground">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-12">
                {videos.map((video) => (
                  <Card key={video.id} className="border card-hover h-full">
                    <CardContent className="p-6 flex flex-col h-full">
                      <div className="relative mb-4 rounded-lg bg-muted aspect-video flex items-center justify-center overflow-hidden">
                        {video.thumbnail_url ? (
